...
namespace AssetPipeline
{
	public static class AssetBundleNameLogic 
	{
		...
		public static void UpdateUIFont(string filePath,Action<string> udpateAction){
			UpdateCheck (filePath, importer => {
				if(importer.UpdateBundleName(importer.GetAssetBundleName(ResGroup.UIFont))){
		...
		public static void UpdateImage(string filePath,Action<string> udpateAction){
			UpdateCheck (filePath, importer => {
