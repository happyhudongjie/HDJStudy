...
namespace Mogo.Util
{
    ...
    public class LoggerHelper
    {
        ...
        static void ProcessExceptionReport(string message,string stackTrace,LogType type)
        {
            UnityEngine.Debug.LogError("ProcessExceptionReport");
        ...
        static void Log(string message,LogLevel level,bool writeEditorLog = true)
        {
#if UNITY_EDITOR
#else
            writeEditorLog = false;
#endif
    ...
    public class LogWriter
    {
        ...
        {
#if UNITY_IPHONE
            m_logWriter(msg,level,writeEdiotrLog);
#else
            m_logWriter.BeginInvoke(msg, level, writeEditorLog, null, null);
#endif
        }

        void Write(string msg,LogLevel level,bool writeEditorLog)
        {
            lock (m_locker)
            {
                try
