...
//		if(mWidget==null) return false;
        ...
        ComponentSelector.Draw<UIAtlas>(mTabBar.atlas, OnSelectAtlas, false);
        ComponentSelector.Draw<UIFont>(mTabBar.font, OnSelectFont, false);
        ...
        if (mTabBar.atlas!=null&&mTabBar.font!=null)
		{
            ...
            NGUIEditorTools.DrawAdvancedSpriteField(mTabBar.atlas, mTabBar.spriteName, SelectSprite, false);

			GUILayout.Label("选中的样式");
			//NGUIEditorTools.AdvancedSpriteField(mTabBar.atlas, mTabBar.selectSpriteName, SelectedSprite, false);
            NGUIEditorTools.DrawAdvancedSpriteField(mTabBar.atlas, mTabBar.selectSpriteName, SelectedSprite, false);
